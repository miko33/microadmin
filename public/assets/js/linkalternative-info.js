...
$("#edit-linkalternative").on('click', function(e) {
    e.preventDefault();
    $(this).hide();
    $("#cancel-edit-linkalternative, #edit-linkalternative-save-btn").show();
    $("#edit-linkalternative-form select, #edit-linkalternative-form input, #edit-linkalternative-form textarea").removeAttr('disabled');
});

$("#cancel-edit-linkalternative").on('click', function(e) {
    e.preventDefault();
    $("#hostname").val(default_hostname);
    $("#title").val(default_title);
    $("#keywords").val(default_keywords);
    $("#description").val(default_description);
    $('#edit-linkalternative-save-btn').hide();
    $("#edit-linkalternative-form select, #edit-linkalternative-form input, #edit-linkalternative-form textarea").attr('disabled', 'disabled');
    $(this).hide();
    $("#edit-linkalternative").show();
});

$("#edit-linkalternative-form").on('submit', function(e) {
    e.preventDefault();
    var that = this;
    $.ajax({
        headers: {
            ...
            if (response.errors) {
                ...
                if(response.icon == 'success') {
                    if($("#hostname").val() != default_hostname) {
                        ...
                        setTimeout(() => {
                            window.location = `${linkalternative_route}/${$("#hostname").val()}`;
                        }, 1000);
                    } else {
                ...
                $("#cancel-edit-linkalternative").trigger('click');
            }
        }
    });
});
