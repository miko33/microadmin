                ...
                <div class="login-center">
                    ...
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('login') ? ' has-error' : ''); ?>">
                            ...
                            <input id="example-login" type="text" placeholder="username" class="form-control form-control-line<?php echo e($errors->has('login') ? ' is-invalid' : ''); ?>" name="login" value="<?php echo e(old('login')); ?>" required autofocus />
                        </div>
                        <div class="form-group<?php echo e($errors->has('login') ? ' has-error' : ''); ?>">
                            <label for="example-password">Password</label>
                            <input id="example-password" type="password" placeholder="password" class="form-control form-control-line<?php echo e($errors->has('login') ? ' is-invalid' : ''); ?>" name="password" required />
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="passcode-form" class="form-horizontal" method="POST" action="<?php echo e(route('passcode')); ?>">
                            <?php echo e(csrf_field()); ?>

                            <p class="text-center text-muted">Enter your passcode to access the admin.</p>
                            <div class="form-group no-gutters">
                                <label for="example-passcode">Passcode</label>
                                <input type="password" class="form-control form-control-line<?php echo e(Session::get('error') ? ' is-invalid' : ''); ?>" name="passcode" id="example-passcode" required autofocus />
