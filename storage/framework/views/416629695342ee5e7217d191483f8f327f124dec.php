		...
		<div class="col-md-12 widget-holder widget-full-content border-all px-0">
			<div class="widget-bg">
				<div class="widget-body clearfix">
					...
					<content-index>
						...
						<div class="row no-gutters">
						    ...
						    <div class="col-md-3 mail-sidebar">
								...
								<form action="<?php echo e(route('microsite.update', $microsite->hostname)); ?>" id="edit-microsite-form">
                                	<div class="row p-auto m-1 ">
										<input type="hidden" name="_method" value="POST"/>
										<input type="hidden" name="id" value="<?php echo e($microsite->id); ?>"/>
										<div class="col-12">
											<div class="form-group">
												<label for="hostname">Hostname</label>
												<input type="text" id="hostname" name="hostname" value="<?php echo e($microsite->hostname); ?>" data-hostname="<?php echo e($microsite->hostname); ?>" class="form-control" disabled>
											</div>
										</div>
										<div class="col-12">
											<div class="form-group">
												<label for="title">Home Title</label>
												<input type="text" id="title" name="title" value="<?php echo e($microsite->home_title); ?>" class="form-control" disabled>
											</div>
										</div>
										<div class="col-12">
											<div class="form-group">
												<label for="keyword">Meta Keyword</label>
												<textarea class="form-control" id="keywords" name="keywords" rows="3" disabled><?php echo e($microsite->meta_keywords); ?></textarea>
											</div>
										</div>
										<div class="col-12">
											<div class="form-group">
												<label for="description">Meta Description</label>
												<textarea class="form-control" id="inputDescription" name="description" rows="3" disabled><?php echo e($microsite->meta_description); ?></textarea>
											</div>
										</div>
										<div class="col-12">
											<div class="form-group">
												<label for="inputCustomTag">Custom Tags</label>
												<textarea class="form-control" id="inputCustomTag" name="custom_tag" rows="3" disabled><?php echo e($microsite->custom_tag); ?></textarea>
											</div>
										</div>
										<div class="col-12">
											<div class="form-group">
												...
												<input type="hidden" id="blogstatus"  value="<?php echo e($microsite->blogs); ?>">
											</div>
										</div>
										<div class="col-12">
						    ...
						    <div class="col-lg-9 col-md-9 mail-inbox">
						        <div class="mail-inbox-header">
						            ...
						            <div class="d-none d-sm-block text-right">
													<?php if(!$microsite->blog->isEmpty()): ?>
													<a class="btn btn-sm btn-color-scheme btn-xl px-4 h6 my-0 fs-16 fw-500 blog"  href="<?php echo e(url('microsites/'.$microsite->hostname.'/blog/'.$microsite->blog[0]->id_blog)); ?>">Manage Blog</a>
													<?php else: ?>
													<a class="btn btn-sm btn-color-scheme btn-xl px-4 h6 my-0 fs-16 fw-500 blog" href="javascript:;" id="createblog">Manage Blog</a>
													<?php endif; ?>
													<a class="btn btn-sm btn-color-scheme btn-xl px-4 h6 my-0 fs-16 fw-500" href="<?php echo e(url('microsites/'.$microsite->hostname.'/images')); ?>">Manage Images</a>
						            	<a class="btn btn-sm btn-color-scheme btn-xl px-4 h6 my-0 fs-16 fw-500" href="<?php echo e(url('microsites/'.$microsite->hostname.'/createpage')); ?>">Create New Page</a>
						            </div>
						            <?php endif; ?>
						        </div>
						        <!-- /.mail-inbox-header -->
					...
					<hr>
						<?php echo $__env->make('pages.microsite._menulist', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
					<hr>
                    <content-index>
						    ...
						    <div class="col-12 mail-inbox">
						        ...
						        <div class="px-4">
						        	<table class="mail-list contact-list table-responsive" id="video-list">
						        		...
						        		<tbody>
                                            <?php if($microsite->options !== null): ?>
                                                <?php $__currentLoopData = $microsite->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group float-right">
                                                            <a href="<?php echo e(route('microsite.editoption', [$microsite->hostname, $option->option_name])); ?>" data-type="<?php echo e($option->option_name); ?>" class="btn btn-default btn-edit-option">
...
<div class="modal fade" id="edit-custom-css" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row p-auto m-1 ">
					<input type="hidden" name="hostname" value="<?php echo e(str_slug($microsite->hostname)); ?>"/>
					<div class="col-12">
						<div class="form-group">
						<textarea rows="10" class="form-control" id="custom-css"><?php echo e(@$microsite->getOptionAttribute('custom_css')->value); ?></textarea>
						</div>
					</div>
				</div>
			</div>
...
var microsite_route = '<?php echo e(route('microsite', '')); ?>';
var microsite_pages = '<?php echo e(route('microsite.pages', $microsite->hostname)); ?>';
var microsite_menus = '<?php echo e(route('microsite.menus', $microsite->hostname)); ?>';
var list_menus = '<?php echo e(route('list.menu', $microsite->hostname)); ?>'
var edit_page_url = '<?php echo e(route('editpage', [$microsite->hostname, ''])); ?>';
var delete_page_url = '<?php echo e(route('microsite.deletepage', [$microsite->hostname, ''])); ?>';
var delete_menu_url = '<?php echo e(route('microsite.deletemenu', [$microsite->hostname, ''])); ?>';
var storeMenu_url = "<?php echo e(route('storeMenu', [$microsite->hostname])); ?>";
var updateMenu_url = "<?php echo e(route('updateMenu', [$microsite->hostname])); ?>";
var getOrdered_menu_url = '<?php echo e(route('getOrderedMenu', $microsite->hostname )); ?>';
var reorder_menu_url = '<?php echo e(route('reorderMenu', $microsite->hostname )); ?>';
var custom_css_url = '<?php echo e(route('saveCustomCss', $microsite->hostname )); ?>';
var fetch_all_pages_url = '<?php echo e(route('fetchAllPages', $microsite->hostname )); ?>';
var clear_cache_url = '<?php echo e(route('clearCache', $microsite->hostname )); ?>';
var storeBlog_url = "<?php echo e(route('storeBlog', [$microsite->hostname])); ?>";

var
	default_hostname = '<?php echo e($microsite->hostname); ?>',
	default_title = '<?php echo e($microsite->home_title); ?>',
	default_keywords = '<?php echo e($microsite->meta_keywords); ?>',
	default_description = '<?php echo e($microsite->meta_description); ?>',
	default_custom_css = $("#custom-css").val(),
	default_blogs ='<?php echo e($microsite->blogs); ?>'
;
</script>
<script src="<?php echo e(url('assets/js/microsite-info.js?v=0.1')); ?>"></script>
<?php $__env->stopPush(); ?>
