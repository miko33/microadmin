...
<body class="body-bg-full error-page error-404" style="background-image: url(<?php echo e(url('/assets/demo/error-page.jpg')); ?>)">;
    <div id="wrapper" class="wrapper">
        <div class="content-wrapper">
            <main class="main-wrapper">
                ...
                <p class="mr-b-30 color-white fs-18 fw-200 heading-font-family"><?php echo e($exception->getMessage() ? $exception->getMessage() : "Sorry! the page you are looking for doesn't exist."); ?></p><a href="javascript: history.back();" class="btn btn-outline-white btn-rounded btn-block fw-700 text-uppercase">Go Back</a>
            </main>
        </div>
        <!-- .content-wrapper -->
    </div>
