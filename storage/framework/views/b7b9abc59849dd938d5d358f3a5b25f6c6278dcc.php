...
<script src="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.18.0/sweetalert2.js"></script>
...
<!-- contextMenu -->
<script src="<?php echo e(url('assets/vendors/jquery-contextmenu/jquery.ui.position.min.js')); ?>"></script>
<script src="<?php echo e(url('assets/vendors/jquery-contextmenu/jquery.contextMenu.min.js')); ?>"></script>

<!-- Moment -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.21.0/moment.min.js"></script>

<!-- Nestable -->
<script src="<?php echo e(url('assets/vendors/nestable-master/jquery.nestable.js')); ?>"></script>

<script src="<?php echo e(url('assets/js/custom.js')); ?>"></script>
<script src="<?php echo e(url('assets/js/theme.js')); ?>"></script>
<script src="<?php echo e(url('assets/js/general.js')); ?>"></script>
