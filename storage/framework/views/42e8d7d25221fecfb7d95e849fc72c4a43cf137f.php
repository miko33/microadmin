				...
				<div class="widget-body clearfix">
                  ...
                  <div class="mail-inbox-header">
                      <div class="mail-inbox-tools d-flex align-items-center">
                          <h5 class="my-auto"><?php echo e($microsite->hostname); ?></h5>
                      </div>
                	...
                	<div class="row p-auto m-1 ">
										<div class="col-12">
											<div class="form-group">
												...
												<input type="text" id="title" name="title" value="<?php echo e($blogs->title); ?>" class="form-control" disabled>
											</div>
										</div>
										<div class="col-12">
											<div class="form-group">
												<label for="keyword">Meta Keyword</label>
												<textarea class="form-control" id="keywords" name="keywords" rows="3" disabled><?php echo e($blogs->meta_keywords); ?></textarea>
											</div>
										</div>
										<div class="col-12">
											<div class="form-group">
												<label for="description">Meta Description</label>
												<textarea class="form-control" id="inputDescription" name="description" rows="3" disabled><?php echo e($blogs->meta_description); ?></textarea>
											</div>
										</div>
										<div class="col-12">
											<div class="form-group">
												<label for="inputCustomTag">Custom Tags</label>
												<textarea class="form-control" id="inputCustomTag" name="custom_tag" rows="3" disabled><?php echo e($blogs->custom_tag); ?></textarea>
											</div>
										</div>
										<div class="col-12">
											<div class="form-group">
												<label for="inputCustomTag">Custom Tags</label>
												<textarea class="form-control" id="inputCustomTag" name="custom_tag" rows="3" disabled><?php echo e($blogs->id_menu); ?></textarea>
											</div>
										</div>
										<div class="col-12">
						    ...
						    <!-- Mails List -->
							 ...
							 <div class="col-lg-9 col-md-9 mail-inbox">
									 ...
									 <div class="row no-gutters mr-l-20">
										 ...
										 <!-- /.mail-inbox-tools -->
										     ...
										     <a class="btn btn-sm btn-color-scheme btn-xl px-4 h6 my-0 fs-16 fw-500" href="<?php echo e(url('microsites/'.$microsite->hostname.'/blog/'.$blogs->id_blog.'/content')); ?>">Create Content</a>
											 </div>
											 <?php endif; ?>
							 ...
							 <div class="row px-4 mt-5 mb-5" id="page-pagination-control">
								...
								<?php echo $__env->make('pages.blogs._blogmenu', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
				</div>
				<!-- /.widget-body -->
			</div>
			<!-- /.widget-bg -->
...
<script>
var blog_page = '<?php echo e(route('contentblog',$blogs->id_blog)); ?>';
var blog_menus = '<?php echo e(route('list.menu',$blogs->id_blog)); ?>';
var editblogpage = '<?php echo e(route('editblogpage',[$microsite->hostname, $blogs->id_blog, ''] )); ?>';
var delete_content = '<?php echo e(route('deleteblog', [$microsite->hostname,$blogs->id_blog, ''] )); ?>';
var delete_list = '<?php echo e(route('deletelist', [$blogs->id_blog, ''] )); ?>';
var fetch_all_content = '<?php echo e(route('fetchAllContent', [$blogs->id_blog] )); ?>';
var fetch_all_menu = '<?php echo e(route('fetchAllMenu', [$blogs->id_blog] )); ?>';
var storeMenus = '<?php echo e(route('createMenus', [$blogs->id_blog] )); ?>';
var upadteMenus = '<?php echo e(route('updateMenus', [$blogs->id_blog] )); ?>';


</script>
<script src="<?php echo e(url('assets/js/blog-option.js?v=0.1')); ?>"></script>
<?php $__env->stopPush(); ?>
