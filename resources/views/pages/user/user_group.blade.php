		...
		<div class="widget-holder col-lg-6 col-md-12 col-sm-12 col-xs-12">
			<div class="widget-bg-transparent">
				<div class="widget-heading widget-heading-border">
					...
					@if (App\General::page_access(Auth::user()->group_id, 'user_group', 'create'))
					<div class="widget-actions">
						<a class="create btn btn-sm btn-primary ml-1" href="javascript:void(0);" data-type="post" data-url="{{ url('user_groups') }}">Create New</a>
					</div>
					@endif
				</div>
...
{{-- 					<div class="col-md-6 ml-auto">
						<div class="row">
							<div class="col-md-2 text-center"> User </div>
							<div class="col-md-2 text-center"> View </div>
							<div class="col-md-2 text-center"> Create </div>
