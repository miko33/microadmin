					...
					<content-index>
						...
						<div class="row no-gutters">
						    ...
						    <div class="col-md-3 mail-sidebar">
								...
								<div class="px-3">
						            <a href="{{url("categories?create=true")}}" id="toCreateCategory">Add new category</a>
						        </div>
						        <!-- /.inbox-labels -->
						    </div>
						    <!-- /.mail-sidebar -->
						        ...
						        <div class="mail-inbox-header">
						        	<div class="mail-inbox-tools d-flex align-items-center">
						        		...
						        		<div class="btn-group">
						        			...
						        			@if (App\General::page_access(Auth::user()->group_id, 'video', 'drop'))
						        			...
						        			<div class="dropdown">
						        				...
						        				<div role="menu" class="dropdown-menu animated fadeIn">
						        					...
						        					@if (App\General::page_access(Auth::user()->group_id, 'trash', 'view'))
						        					<div class="dropdown-divider"></div>
						        					<a class="dropdown-item" href="{{ url('/videos/trash') }}">Trash</a>
						        					@endif
						        				</div>
						        			</div>
						        			<!-- /.dropdown -->
						            ...
						            @if (App\General::page_access(Auth::user()->group_id, 'video', 'create'))
						            <div class="d-none d-sm-block text-right">
						            	<a class="create btn btn-color-scheme btn-xl px-4 h6 my-0 fs-16 fw-500" href="javascript:void(0);" data-type="post" data-url="{{ url('videos') }}" data-params="prefix=_videos">Add Video</a>
						            </div>
						            @endif
