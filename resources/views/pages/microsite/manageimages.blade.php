                                        ...
                                        <tbody id="images-container">
                                            @foreach($images as $key => $image)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <button id="delete" data-delete-type="swal" data-type="delete" data-url="{{route('deleteImage', [$microsite->hostname, $image->id])}}" type="button" class="btn btn-default">
                                ...
                                <div class="row px-4 mt-5 mb-5" id="images-pagination-control">
						            ...
						            <div class="col-5">
                                        <div class="btn-group float-right pagination-controls">
                                            ...
                                            <a href="{{url('microsites/'.$microsite->hostname.'/images')}}?page=2" class="btn fs-18 bw-1 radius-0 btn-outline-default ripple px-2 next">
...
<script>
    ...
    var imagesRoute = "{{route('images', [$microsite->hostname])}}";
</script>
<script src="{{ url('assets/js/edit-sliderimages.js?v=0.1') }}"></script>
<script src="{{ url('assets/js/manage-images.js?v=0.1') }}"></script>
@endpush