                        ...
                        <div class="col-12 mail-inbox">
                            <div class="mail-inbox-header">
                                ...
                                <div class="d-none d-sm-block text-right">
                                    <a class="create btn btn-sm btn-color-scheme px-4 h6 my-0 fs-16 fw-500" data-type="post" data-url="{{ route('createfooter', $microsite->hostname) }}"  href="javascript:void(0);">Create New Footer Button</a>
                                </div>
                                @endif
...
@push('scripts')
<script>
    var footer_buttons_url = '{{ route('footer', $microsite->hostname) }}';
    var delete_footer_url = '{{ route('deletefooter', [$microsite->hostname, '']) }}';
    var edit_footer_url = '{{ route('updatefooter', [$microsite->hostname, '']) }}';
</script>
<script src="{{ url('assets/js/edit-footerbuttons.js?v=0.1') }}"></script>
@endpush