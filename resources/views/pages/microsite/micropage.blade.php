...
<script>
    ...
    var storePage = "{{route('storepage', [$microsite->hostname])}}";
    var updatePage = "{{route('updatepage', [$microsite->hostname])}}";
    var redirectTo = '{{route('microsite', $microsite->hostname)}}';
    var image_list = [
...
<script src="{{ url('assets/js/micropage.js?v=0.1') }}"></script>
@endpush