        ...
        <div class="col mail-inbox">
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <br/>
                    <img src="{{@$option->instruction_image_url}}" id="instruction_image_image" alt="" height="150" class="img img-thumbnail" style="height: 150px; width: auto; margin-bottom: 15px; @if(strlen(@$option->instruction_image_url) == 0) display: none; @endif">
                    <div class="form-group">
                        <input type="file" id="instruction_image" name="instruction_image" class="form-control">
                        <input type="hidden" id="instruction_image_url" name="instruction_image_url" value="{{@$option->instruction_image_url}}">
                    </div>
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                    ...
                    <div class="form-group">
                        <textarea type="text" id="liveChatCode" name="liveChatCode" class="form-control">{{$option->livechat_code}}</textarea>
                    </div>
                </div>
                <div class="col-3">
...
<script>
    ...
    var updateHomeContentRoute = "{{route('linkAlternative.updateHomeContent', [$linkalternative->hostname])}}";
    var image_list = [
...
<script src="{{ url('assets/js/edit-linkalternative-homecontent.js?v=0.1') }}"></script>
@endpush