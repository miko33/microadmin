...
<content-index>
<link rel="stylesheet" href="{{url('assets/css/documentation.css')}}" type="text/css">
	...
	<div id="bodyContent" class="mw-body-content">
		<div id="mw-content-text" lang="id" dir="ltr" class="mw-content-ltr">
			<div class="">
				...
				<a href="{{route('adddoc')}}" class="create btn btn-sm btn-primary ml-1 float-right" style=" margin:10px;"> Add Documentation</a>
			<div id="div1" class="mw-parser-output row container-fluid bg-white">
				...
				<content-form>
					...
					@endsection
					@push('scripts')
					<script src="{{url('assets/js/documentation.js?v=0.1')}}"></script>
					<script src='http://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js'></script>
