		...
		<form class="form-inline " method="get" action="{{ url('/')}}">
			...
			<div class="input-group mb-2 mr-sm-2 mb-sm-0">
				<div class="input-daterange input-group datepicker">
					...
					<input id="start" type="text" class="form-control" name="start" value="{{$startdate}}"/>
					<span class="input-group-addon bg-info text-inverse ml-1">to</span> 
					<input id="end" type="text" class="form-control" name="end" value="{{$endDate}}"/>
				</div>
			</div>
						...
						<div class="counter-w-info">
							<div class="counter-title">
								<div class="d-flex justify-content-center align-items-end">
									<div data-toggle="circle-progress" data-start-angle="30" data-thickness="6" data-size="40" data-value="0.58" data-line-cap="round" data-empty-fill="#E2E2E2" data-fill='{"gradient": ["#40E4C2", "#0087FF"], "gradientAngle": -90}'></div><span class="counter ml-3">{{$category}}</span>
								</div>
								<!-- /.d-flex -->
							</div>
							<!-- /.counter-title -->
			...
			<div class="widget-holder widget-sm widget-border-radius col-md-6 col-lg-3">
				<div class="widget-bg">
					...
					<div class="widget-body">
						<div class="counter-w-info">
							<div class="counter-title">
								<div class="d-flex justify-content-center align-items-center"><span data-toggle="sparklines" sparkheight="25" sparktype="bar" sparkchartrangemin="0" sparkbarspacing="3" sparkbarcolor="#947AE8" sparkbarcolor="red"><!-- 2,4,5,3,2,3,5 --> </span><span class="align-bottom ml-2"><span class="counter">{{$video}}</span></span>
								</div>
								<!-- /.d-flex -->
							</div>
							<!-- /.counter-title -->
