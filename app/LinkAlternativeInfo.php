...
class LinkAlternativeInfo extends Model
{
    protected $connection = 'mysqlmicrosite';
    protected $table = 'linkalternative_info';
    ...
    {
        return $this->hasMany('\App\LinkAlternativeOptions', 'site_id');
    }

    public function menus()
    {
        return $this->hasMany('\App\LinkAlternativeMenu', 'site_id');
    }

    public function pages()
    {
        return $this->hasMany('\App\LinkAlternativePage', 'site_id');
    }

    public function images()
    {
        return $this->hasMany('\App\LinkAlternativeMedia', 'site_id');
    }
    ...
    public function setOptionAttribute($option_name, $values)
    {
        ...
        if($data) {
            ...
            $data = new \App\LinkAlternativeOptions;
